package COMS227_HW3_S24_skeleton2.COMS227_HW3_S24_skeleton.src;
...
public class SimpleTests {
	public static void main(String args[]) {
		...
		GameFileUtil.load("C:\\Users\\miles\\OneDrive - VoilaTech, LLC\\Desktop\\COMS227\\Assignment2Take2\\src\\COMS227_HW3_S24_skeleton2\\COMS227_HW3_S24_skeleton\\examples/game1.txt", game);
		System.out.println("Expected a message saying the number of lizards is now 1.");
		System.out.println("DO NOT print this message in GameFileUtil, the ScoreListener needs to be called in LizardGame.");
		...
		System.out.println("The cell at (1,1) has a wall (" + (game.getCell(1, 1).getWall() != null) + "), expected true.");
		System.out.println("The cell at (7,2) has an exit (" + (game.getCell(7, 2).getExit() != null) + "), expected true.");
		System.out.println("The cell at (2,2) has a lizard (" + (game.getCell(2, 2).getLizard() != null) + "), expected true.");
